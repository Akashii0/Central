...
from app.sample_module.users.api import router as users_router
from app.sample_module.files.api import router as files_router
...
app.include_router(users_router, tags=[tags.USERS])
app.include_router(files_router, tags=[tags.FILES])
